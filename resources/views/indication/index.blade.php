                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex space-x-4">
                                                <a href="{{ route('indication.edit', $indication->id) }}"
                                                    class="btn btn-sm btn-primary">Edit</a>
                                                <form action="{{ route('indication.destroy', $indication) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            <form method="POST" action="{{ route('indication.store') }}">
                @csrf
                <h3 class="font-bold text-lg text-center">Add Data Indication</h3>
                <div class="my-2 px-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Indication Code" name="indication_code"
                ...
                <div class="mb-2 px-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" placeholder="Indication Name" name="indication_name"
                            class="input input-bordered max-w" required />
